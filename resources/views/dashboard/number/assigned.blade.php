                            ...
                            <tr id="row-{{ $number->id }}"
                                ...
                                <td class="d-block d-md-table-cell">
                                    ...
                                    <div class="btn-group d-flex flex-column flex-md-row ml-10">
                                        <a href="#" data-toggle="modal" data-target="#responseModal{{$number->id}}"
                                           class="btn btn-warning btn-sm mb-2 mb-md-0 mr-md-2">Response</a>

                                        <div class="modal fade" id="responseModal{{$number->id}}" tabindex="-1" role="dialog" aria-labelledby="responseModalLabel"
                                             aria-hidden="true">
