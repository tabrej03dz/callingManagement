...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{asset('asset/landing/inc/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
        <link href="{{asset('asset/landing/inc/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
...
{{--        </style>--}}
    ...
    <header class="bg-light py-5 " style="background-image:url({{asset('asset/landing//img/header-bg.jpg')}});background-size: cover; background-position: center;">
                        ...
                        <div class="position-center top-0 end-0 p-3">
                            ...
                            @else
                                ...
                                {{-- <a href="{{ route('register') }}"
                                    class="ml-4 btn btn-outline-dark font-weight-bold">Register</a> --}}
                                {{-- @endif--}}
                            @endauth
                        </div>
                    @endif
    ...
    <!-- About Section Start -->
            ...
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 img-cols">
                        <div class="img-col">
                            <div class="img">
                                <img src="{{asset('asset/landing/img/about.jpg')}}">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row align-items-center text-center">
                    ...
                    <div class="col-md-6 d-none d-md-block">
                        <div class="f-img">
                            <img src="{{asset('asset/landing/img/mobile.png')}}" alt="Mobile Image" />
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-12">
                        <div class="f-item">
        ...
        <script src="{{asset('asset/landing/vendor/jquery/jquery.min.js')}}"></script>
        <script src="{{asset('asset/landing/vendor/jquery/jquery-migrate.min.js')}}"></script>
